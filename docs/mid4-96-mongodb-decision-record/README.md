...
## MID4-247까지의 현재 구현 상태

MID4-135 이후 MID4-247까지의 작업은 MongoDB 적용 결론을 변경하지 않고, 후속 구현과 비교 검증에 필요한 환경, Outbox 저장 구조, producer와 비동기 projection을 단계적으로 추가했다.
